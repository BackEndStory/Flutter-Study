...
class HomeScreen7 extends StatelessWidget{
  static final LatLng companyLatLng = LatLng(37.665375, 127.057614);
  static final Marker marker = Marker(markerId: MarkerId('MyHouse'),
                      ...
                      children: [
                        ...
                        ElevatedButton(onPressed: () async{
                          ...
                          showDialog(context: context, builder: (_){
                                return AlertDialog(
                                  title: Text('출근하기'),
                                  content: Text( canCheck ? '출근을 하시겠습니까?' : '출근할 수 없는 위치입니다.'),
                                  actions: [
